...
var Select2Selects = function() {
    ...
    var _componentSelect2 = function() {
        ...
        var array_data_jenisperizinan = [
            {id: '1', text: 'IZIN PENYELENGGARAAN JARINGAN TELEKOMUNIKASI'}
        ];
        var array_data_kbli = [
            {id: '61100', text: '61100 - Aktivitas Telekomunikasi dengan Kabel'}
        ];
        var array_data_jenislayanan = [
            {id: '59000000051', text: 'Izin Penyelenggaraan Jasa teleponi dasar melalui jaringan telekomunikasi'},
            {id: '59000000044', text: 'Izin Penyelenggaraan Jaringan Tetap Sambungan Internasional'},
            {id: '59000000043', text: 'Izin Penyelenggaraan Jaringan Tetap Sambungan Langsung Jarak Jauh'},
            {id: '59000000042', text: 'Izin Penyelenggaraan Jaringan Tetap Lokal Berbasis Circuit Switched'},
            {id: '59000000041', text: 'Izin Penyelenggaraan Jaringan Tetap Lokal Berbasis Packet Switched melalui Media Fiber Optik'}
        ];
