...
var form_jasa_nap = function () {
	...
	var initForm = () => {
		...
		$("#simpan-jasa-nap").click(function() {	
			...
			$.ajax({
				...
				data: new FormData(document.getElementById("form_jasa_nap")),
				processData: false,
				contentType: false,
        ...
        $("#tambah-jasa-nap").click(function() {			
			$("#body-jasa-nap").append(foRow);
            initiateKabKota();
		});
		
		$("#body-jasa-nap").on('click','.remove',function(){
		...
		var foRow = `
                <tr>
                    ...
                    <td><input type="text" name="lokasi[]" class="form-control" placeholder=""/></td>
                    <td><input type="text" name="kapasitas_bw_domestik[]" class="form-control" placeholder=""/></td>
                    <td><input type="text" name="kapasitas_bw_int[]" class="form-control" placeholder=""/></td>
                    <td class="items-align-center text-end">
                    <button id="jasa-nap-delete-`+ (number) + `" class="btn btn-icon btn-danger remove w-30px h-30px">
