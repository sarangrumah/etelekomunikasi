...
class CommonHelper
{
    ...
    {
        $ulo = new Ulo();
        $ulo = $ulo->view_ulo_all()->where('status_ulo', '=', $status)->count();
        // $Ulo = Ulo::select('tb_trx_ulo.*')->leftjoin('vw_list_izin','vw_list_izin.id_izin','=','tb_trx_ulo.id_izin')->leftjoin('tb_mst_usertesting','tb_mst_usertesting.oss_id','=','vw_list_izin.oss_id')->whereNotNull('tb_mst_usertesting.oss_id')->where('status_ulo', '=', $status)->get()->count();
        return $ulo;
    }
