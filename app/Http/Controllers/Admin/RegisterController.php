    ...
    */
    ...
    protected function create(array $data = [])
    {
        ...
        if ($cekTableNib){
            ...
            redirect('/login')->with('message', 'Mohon maaf proses registrasi tidak berhasil dilakukan, NIB / Nama Perusahaan / Instansi telah terdaftar');
        }
    ...
    {
        $CekNibTable = Nib::where(['nib' => $nib])->orwhere(['nib' => $name_pt])->get();
    ...
    public function register(Request $request)
    {
        ...
        if ($request->jenis_pu == 'PTB' || $request->jenis_pu == 'TKB') {
