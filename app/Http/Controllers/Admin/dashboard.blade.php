                ...
                <div class="d-inline-flex align-items-center ml-auto">
                    <div class="dropdown ml-2">
                        @if ($status_evaluasi == '0')
                            {{-- <div>
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#"
                                        data-popup="tooltip" title="Akun Anda belum terverifikasi"
                            ...
                            @if (Auth::user()->jenis_pu == 'NPT')
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-target="#modalCekPenomoran">Permohonan Penomoran <i
                            ...
                            @elseif (Auth::user()->jenis_pu == 'PTB')
                                ...
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#"
                                        data-popup="tooltip" title="Akun Anda belum terverifikasi"
                                        data-placement="left">Penetapan Penomoran <i class="icon-file-plus mr-2"></i></button>
                                </td>
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#"
                                        data-popup="tooltip" title="Akun Anda belum terverifikasi"
                                        data-placement="left">Pengembalian Penomoran <i class="icon-file-plus mr-2"></i></button>
                                </td>
                        ...
                        @else
                            ...
                            @elseif (Auth::user()->jenis_pu == 'PTB' && $status_evaluasi == '1')
                                ...
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-target="#tambahData_nomor">Penetapan Penomoran <i
                                            class="icon-file-plus mr-2"></i></button></td>
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-target="#tambahData_nomor">Pengembalian Penomoran <i
                                            class="icon-file-plus mr-2"></i></button></td>
                                {{-- <a href="javascript:void(0)" class="dropdown-item"><i class="icon-database-refresh"></i>
                                    Perbaharui Data </a> --}}
                            @elseif (Auth::user()->jenis_pu == 'TKB' && $status_evaluasi == '1')
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-target="#tambahData">Tambah Permohonan <i
                                            class="icon-file-plus mr-2"></i></button></td>
                                {{-- <a href="javascript:void(0)" class="dropdown-item"><i class="icon-database-refresh"></i>
                                    Perbaharui Data </a> --}}
                            @elseif (Auth::user()->jenis_pu == 'TKI' && $status_evaluasi == '1')
                                <td><button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-target="#tambahData_nomor">Tambah Permohonan <i
                                            class="icon-file-plus mr-2"></i></button></td>
                                {{-- <a href="javascript:void(0)" class="dropdown-item"><i class="icon-database-refresh"></i>
                                    Perbaharui Data </a> --}}
                            @endif
                    ...
                    @foreach ($izin as $item)
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge badge-success-100 text-success">{{ $item->status_fo }}</span></td>
                            <td>
                                <div class="dropdown">
                                    <a href="javascript:void(0)"
                                        class="btn btn-outline-light btn-icon btn-sm text-body border-transparent rounded-pill"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @if ($item['jenis_perizinan'] != 'K03')
                                            @if ($item['status_checklist'] == '00' || $item['status_checklist'] == '02' || $item['status_checklist'] == '03')
                                            ...
                                            @elseif($item['status_checklist'] == '01')
                                                <a href="{{ url('pb/pemenuhan-persyaratan/') . '/' . $item->id_izin }}"
                                                    ...
                                                    Persyaratan</a>
                                            @endif
                                            {{-- @if ($item['layanan_penomoran'] == '1' && $item['status_checklist'] == '00')
									...
									Informasi Perizinan</a> --}}
                                            ...
                                            @if (
                                                ...
                                                <a href="{{ url('komitmen/perubahan') . '/' . $item->id_izin }}"
                                                    class="dropdown-item" target="_blank"><i class="icon-history"></i>
                                        ...
                                        @else
                                            @if ($item['layanan_penomoran'] == '1' && $item['status_checklist'] == '00')
                                                <a href="{{ url('/penomoran/') . '/' . $item->id_izin }}"
                                                    class="dropdown-item"><i class="icon-file-upload"></i> Permohonan Kode
                                                    Akses</a>
                                            @else
                                                <a href="{{ url('pb/historyperizinan/') . '/' . $item->id_izin }}"
                                                    class="dropdown-item" target="_blank"><i class="icon-history"></i>
