...
class SurveiController extends Controller
{
    ...
    public function respond_list()
    {
        ...
        return response()->view('layouts.backend.survey.respond_survei',['list_header'=>$list_header, 'date_reformat' => $date_reformat]);
    }
    ...
    public function result_survei_detail($period_month, $period_year, Request $req)
    {
        ...
        ->where('period_year','=',$period_year)
        ->get();
        $list_summary_ikm_unsur = DB::table('vw_survei_respond__detail_ikm_all_unsur')
        ->where('period_month','=',$period_month)
        ->where('period_year','=',$period_year)
        ->get();
        ...
        ->get();
        // dd($list_summary);
        return response()->view('layouts.backend.survey.result_survei_detail',['list_summary'=>$list_summary, 'list_summary_ikm'=>$list_summary_ikm, 'list_summary_ikm_unsur'=>$list_summary_ikm_unsur, 'list_summary_iipp'=>$list_summary_iipp, 'list_summary_quest02'=>$list_summary_quest02, 'list_summary_quest03'=>$list_summary_quest03]);
    }
    ...
    public function result_new($id)
    {
        ...
        $list_ans_ikm_unsur = DB::table('vw_survei_respond__detail_ikm_all_unsur_each_idrespond')->where('vw_survei_respond__detail_ikm_all_unsur_each_idrespond.id_respond','=',$id)->get();
        ...
        ['survei_list_header'=>$survei_list_header, 'date_reformat' => $date_reformat,
            ...
            'list_ans_ikm_unsur'=>$list_ans_ikm_unsur,
        ]);   
    }
}
