...
Route::post('/admin/login', [Admin\LoginController::class, 'login'])->name('admin.login')->middleware('jabatancheck');
...
Route::group(['prefix' => 'admin'], static function () {
    Route::middleware(['admin'])->group(function () {
        ...
        Route::post('/subkoordinator/evaluasiulopost/{id}/{urut}', [Admin\SubkoordinatorController::class, 'evaluasiUloPost'])->name('admin.subkoordinator.evaluasiulopost')->middleware('jabatancheck');
        ...
        Route::get('/subkoordinator/evaluasi-penomoran/{id}/{idkodeakses}', [Admin\SubkoordinatorController::class, 'evaluasiPenomoran'])->name('admin.subkoordinator.evaluasi-penomoran')->middleware('jabatancheck');
        ...
        Route::post('/evaluator/evaluasi-penomoranPost/{id}/{idkodeakses}', [Admin\EvaluatorController::class, 'evaluasiPenomoranPost'])->name('admin.evaluator.evaluasi-penomoran-post')->middleware('jabatancheck');
        ...
        Route::get('/sk/draft/{id}/{urut}', [Admin\SkController::class, 'draft'])->name('admin.sk.draft')->middleware('jabatancheck');
        ...
        Route::get('/laporan-register', [Admin\RekapController::class, 'AllRegister'])->name('admin.laporan-register')->middleware('jabatancheck');
