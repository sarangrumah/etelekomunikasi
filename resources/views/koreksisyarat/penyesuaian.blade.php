...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
				<div>
                    <form id="form-persyaratan" action="{{ url('/komitmen/koreksi-penyesuaian', $id) }}" method="post" enctype="multipart/form-data">
					@csrf
					<input type="hidden" name="id_izin" value="{{$izin['id_izin']}}">
                    <label for="">Surat Pernyataan Perubahan Komitmen</label>
                    <div class="form-group">
                        <div class="input-group">
                        <input type="file" accept="application/pdf" class="form-control" name="surat_pernyataan"/>
                    ...
                    @endif
                    <br>
                    <label for="" class="mb-0 mt-1 text-danger font-weight-bold">Pesan Perbaikan</label>
                        <textarea type="text" class="form-control" disabled>{{ $penyesuaian->correction_note }}</textarea>
                    <br>
