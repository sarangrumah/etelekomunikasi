...
@section('js')
	...
	<script src="{{ url('global_assets/js/demo_pages/datatables_extension_buttons_init.js') }}"></script>

	<script src="{{ url('global_assets/js/plugins/extensions/jquery_ui/interactions.min.js') }}"></script>
	<script src="{{ url('global_assets/js/plugins/forms/selects/select2.min.js') }}"></script>

	<script src="{{ url('global_assets/js/kominfo/form_option_kominfo.js') }}"></script>
			...
			<table class="table text-nowrap">
				<thead>
					<tr>
						...
						<th class="col-3">Detail Pengguna Layanan</th>
						<th class="col-6">Pesan Layanan</th>
				...
				<tbody>
					...
					@if ($vwhld_open_count > 0)
						@if (isset($vwhld_open) && $vwhld_open > 0)
									...
									<td class="col-6 text-wrap">
										<a href="/updatelayanan/{{ $help_open->id }}" class="text-body">
											<div class="font-weight-semibold">[Layanan {{ $help_open->jenis_layanan }}
												#{{ $help_open->id }}]</div>
											<span class="d-inline-block text-truncate text-muted">{{ $help_open->judul_pesan_layanan }}</span>
										</a>
									</td>
									<td class="text-center">
