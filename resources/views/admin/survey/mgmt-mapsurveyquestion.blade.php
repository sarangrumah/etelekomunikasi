...
<div class="card">
    <div class="card-header bg-primary text-white header-elements-inline">
        <h5 class="card-title py-3">Survei</h5>
    </div>
    ...
    <div class="card-body">
        <fieldset class="mb-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div>
                        <span class="form-control form-control-outline">{{$survey->survey_name}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div>
                        <span class="form-control form-control-outline">{{$survey->survey_desc}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div>
                        <select name="category" class="form-control form-control-outline" disabled>
                            <option {{$survey->category == '1' ? 'selected':''}} value="1">IKM KINERJA (PERFOMANCE)</option>
                            <option {{$survey->category == '2' ? 'selected':''}} value="2">IKM TINGKAT HARAPAN (EXPECTATION)</option>
                            <option {{$survey->category == '3' ? 'selected':''}} value="3">IPP</option>
                            <option {{$survey->category == '4' ? 'selected':''}} value="4">PERTANYAAN TERBUKA</option>
                            <option {{$survey->category == '5' ? 'selected':''}} value="5">IN-DEPTH QUESTIONS</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        <span class="form-control form-control-outline">{{$survey->period_start}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        <span class="form-control form-control-outline">{{$survey->period_end}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div>
                        <span class="form-control form-control-outline">{{$survey->expected_result}}</span>
                    </div>
                </div>
            </div>
...
<div class="card">
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.svmgmt.add-question', $id) }}" class="form-horizontal">
        @csrf
        <table class="table">
            <thead>
                <tr>
