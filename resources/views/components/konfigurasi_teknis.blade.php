                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_kantor_pusat_layanan_pelanggan]" {{ $is_editable ? "" : "" }} required>{{$d['alamat_kantor_pusat_layanan_pelanggan']}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Alamat <i>Dummy Client</i></label>
                            <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_dummy_client]" {{ $is_editable ? "" : "" }} required>{{$d['alamat_dummy_client']}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Alamat NOC</label>
                            <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_noc]" {{ $is_editable ? "" : "" }} required>{{$d['alamat_noc']}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Alamat Kolokasi</label>
                            <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_kolokasi]" {{ $is_editable ? "" : "" }} required>{{$d['alamat_kolokasi']}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Alamat Instalasi Jaringan</label>
                            <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_instalasi_jaringan]" {{ $is_editable ? "" : "" }} required>{{$d['alamat_instalasi_jaringan']}}</textarea>
                        </div>
                    </div>
                </div>
                {{-- <hr class="w-100"/> --}}
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="konfigurasi_teknis[{{ $key }}][nama_perangkat]" value="{{$d['nama_perangkat']}}" required {{ $is_editable ? "" : "" }} />
                        </div>
                        <div class="form-group">
                            <label for="">Merk / Tipe Perangkat</label>
                            <input class="form-control" name="konfigurasi_teknis[{{ $key }}][merk_type]" value="{{$d['merk_type']}}" required {{ $is_editable ? "" : "" }} />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Media Akses</label>
                            <input class="form-control" name="konfigurasi_teknis[{{ $key }}][media_akses]" value="{{$d['media_akses']}}" required {{ $is_editable ? "" : "" }} />
                        </div>
                        <div class="col-12">
            ...
            @else
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="">Alamat Instalasi Jaringan</label>
                            <textarea class="form-control" name="konfigurasi_teknis[0][alamat_instalasi_jaringan]" required></textarea>
                        </div>
                    </div>
                </div>
                <hr class="w-100"/>
                    ...
                    <div class="px-3 py-3 mt-3 konfigurasi-teknis-item" style="border: 1px solid #ddd;position: relative;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="">Alamat Instalasi Jaringan</label>
                                    <textarea class="form-control alamat_instalasi_jaringan" name="konfigurasi_teknis[` + this.totalKonfigurasiTeknis + `][alamat_instalasi_jaringan]" required></textarea>
                                </div>
                            </div>
                        </div>
                        <hr class="w-100"/>
