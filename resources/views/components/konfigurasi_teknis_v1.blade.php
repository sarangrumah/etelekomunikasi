    ...
    <div id="konfigurasi_teknis_lists">
        ...
        @if($datajson !== "kosong")
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Alamat Node A</label>
                        <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_node_a]" {{ $is_editable ? "" : "disabled" }} required>{{$d['alamat_node_a']}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Alamat Node B</label>
                        <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_node_b]" {{ $is_editable ? "" : "disabled" }} required>{{$d['alamat_node_b']}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Alamat Tier 1</label>
                        <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_tier]" {{ $is_editable ? "" : "disabled" }} required>{{$d['alamat_tier']}}</textarea>
                    </div>
                </div>
            </div>
            {{-- <hr class="w-100"/> --}}
        ...
        @else
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Alamat Node A</label>
                        <textarea class="form-control" name="konfigurasi_teknis[0][alamat_node_a]" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Alamat Node B</label>
                        <textarea class="form-control" name="konfigurasi_teknis[0][alamat_node_b]" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Alamat Tier 1</label>
                        <textarea class="form-control" name="konfigurasi_teknis[0][alamat_tier]" required></textarea>
                    </div>
                </div>
            </div>
            <hr class="w-100"/>
...
<script>
    $('document').ready(function() {
        ...
        const addRencanaUsahaItem = function() {
            ...
            $('#add-konfigurasi-tekns').on('click', function() {
                ...
                const inputRow = `
                    <div class="px-3 py-3 mt-3 konfigurasi-teknis-item" style="border: 1px solid #ddd;position: relative;">
                        <button
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Alamat Node A</label>
                                    <textarea class="form-control alamat_node_a" name="konfigurasi_teknis[` + this.totalKonfigurasiTeknis + `][alamat_node_a]" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat Node B</label>
                                    <textarea class="form-control alamat_node_b" name="konfigurasi_teknis[` + this.totalKonfigurasiTeknis + `][alamat_node_b]" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat Tier 1</label>
                                    <textarea class="form-control alamat_tier" name="konfigurasi_teknis[` + this.totalKonfigurasiTeknis + `][alamat_tier]" required></textarea>
                                </div>
                            </div>
                        </div>
                        <hr class="w-100"/>
    ...
    function onDeleteRencanaKonfigurasiTeknis(e) {
            ...
            $('.konfigurasi-teknis-item').each(function(index, element) {
                ...
                $(this).find('.alamat_node_a').attr('name', 'konfigurasi_teknis[' + index + '][alamat_node_a]');
                $(this).find('.alamat_node_b').attr('name', 'konfigurasi_teknis[' + index + '][alamat_node_b]');
                $(this).find('.alamat_tier').attr('name', 'konfigurasi_teknis[' + index + '][alamat_tier]');
