...
class DirekturController extends Controller
{
    ...
    public function index(){
        ...
        return
        view('layouts.backend.direktur.dashboard',['date_reformat'=>$date_reformat,'ulo'=>$ulo_full,'countulo'=>$countulo,'penomoran'=>$penomoran,'countpenomoran'
    ...
    public function putFileSKPenetapan($id_izin)
    {
        ...
        if ($id_master_izin == 1) {
            $pdf = PDF::loadView('layouts.backend.sk.cetak-penetapan-jasa', ['nama_perseroan' => $nama_perseroan, 'data' => $data, 'cities' => $cities, 'map_izin_perubahan' =>$map_izin_perubahan, 'mst_kode_izin' => $mst_kode_izin]);
        }else{
            $pdf = PDF::loadView('layouts.backend.sk.cetak-penetapan', ['nama_perseroan' => $nama_perseroan, 'data' => $data, 'cities' => $cities, 'map_izin_perubahan' =>$map_izin_perubahan, 'mst_kode_izin' => $mst_kode_izin]);
        }
