...
<div class="table-responsive">
	<table class="table table-custom table-sm">
		<thead>
			<tr>
				<th rowspan="2" class="col-1 text-center">Tahun</th>
				<th colspan="2" class="col-3 text-center">Pusat Pelayanan Pelanggan</th>
				<th rowspan="2" class="col-3 text-center">Cakupan Wilayah Layanan (Kota/Kab)</th>
				<th rowspan="2" class="col-3 text-center">Kapasitas Bandwidth Internasional (Mbps)</th>
				<th rowspan="2" class="col-2 text-center">
					@if ($is_editable)
						Hapus?
					@endif
				</th>
					...
					@if (isset($d['isdeleted_rencanausaha']))
						@if ($d['isdeleted_rencanausaha'] == '1')
							<tr class="rencanausaha-item">
								...
								<td class="col-3">
									<select {{ $is_editable ? '' : 'readonly' }} name="rencanausaha[{{ $key }}][wilayah_layanan]"
										id="" class="form-control wilayah-layanan select2" required>
										<option value="">Pilih kota</option>
										@foreach ($cities as $city)
											<option value="{{ $city->id }}" {{ $d['wilayah_layanan'] == $city->id ? 'selected' : '' }}
								...
								<td class="col-2">
									<input {{ $is_editable ? '' : 'readonly' }} value="{{ $d['kapasitas_e1'] }}" type="number" min="1"
										...
										@if (isset($d['isdeleted_rencanausaha']))
											<div>
												<select name="rencanausaha[{{ $key }}][isdeleted_rencanausaha]" id=""
													...
													<option name="rencanausaha[{{ $key }}][isdeleted_rencanausaha]" value="1"
														{{ $d['isdeleted_rencanausaha'] == 1 ? 'selected' : '' }}>
														Tidak
													</option>
													<option name="rencanausaha[{{ $key }}][isdeleted_rencanausaha]" value="2"
