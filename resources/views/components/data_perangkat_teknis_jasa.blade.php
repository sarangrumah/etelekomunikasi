        ...
        <div class="px-3 py-3 data_perangkat_teknis_jasa-item" style="border: 1px solid #ddd">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="konfigurasi_teknis[{{ $key }}][alamat_instalasi_jaringan]"
                            {{ $is_editable ? "" : "" }} required>{{$d['alamat_instalasi_jaringan']}}</textarea>
                    </div> --}}
                </div>
            </div>
            {{--
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="data_perangkat_teknis_jasa[{{ $key }}][tipe_perangkat]"
                            value="{{$d['tipe_perangkat']}}" required {{ $is_editable ? "" : "" }} />
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" name="data_perangkat_teknis_jasa[{{ $key }}][buatan_perangkat]"
                            value="{{$d['buatan_perangkat']}}" required {{ $is_editable ? "" : "" }} />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="data_perangkat_teknis_jasa[{{ $key }}][sn_perangkat]"
                            value="{{$d['sn_perangkat']}}" required {{ $is_editable ? "" : "" }} />
                    </div>
                    <div class="form-group">
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <?php
                                    ...
                                    ?>
                                <input {{ $is_editable ? "" : "" }}
                                    name="data_perangkat_teknis_jasa[{{ $key }}][foto_perangkat]" value="{{$name[2]}}"
                                ...
                                <span class="input-group-append">
                                    <?php 
                                        if (isset($d['foto_perangkat']) && $d['foto_perangkat'] != '') {
                                            ?><a target="_blank" href="{{ url($d['foto_perangkat'])}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="data_perangkat_teknis_jasa[{{ $key }}][sertifikat_perangkat]"
                            value="{{$d['sertifikat_perangkat']}}" required {{ $is_editable ? "" : "" }} />
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="">Alamat Kolokasi</label>
                        <textarea class="form-control" name="konfigurasi_teknis[0][alamat_kolokasi]"
                            required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Alamat Instalasi Jaringan</label>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Tipe Perangkat</label>
                        <input class="form-control tipe_perangkat" name="data_perangkat_teknis_jasa[0][tipe_perangkat]" required />
                    </div>
                    <div class="form-group">
                        <label for="">Negara Asal Pembuat Perangkat</label>
                        <input class="form-control buatan_perangkat" name="data_perangkat_teknis_jasa[0][buatan_perangkat]" required />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Nomor Serial Perangkat</label>
                        <input class="form-control sn_perangkat" name="data_perangkat_teknis_jasa[0][sn_perangkat]" required />
                    </div>
                    <div class="form-group">
                        <label for="">Foto Perangkat</label>
                        <input type="file" accept="application/pdf" class="form-control"
                            name="data_perangkat_teknis_jasa[0][foto_perangkat]" required />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Sertifikat Perangkat</label>
                        <input class="form-control" name="data_perangkat_teknis_jasa[0][sertifikat_perangkat]"
                            required />
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="px-3 py-5 mt-3 data_perangkat_teknis_jasa-item" style="border: 1px solid #ddd;position: relative;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Negara Asal Pembuat Perangkat</label>
                                    <input class="form-control buatan_perangkat" name="data_perangkat_teknis_jasa[` + this.totalKonfigurasiTeknis + `][buatan_perangkat]" required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="">Foto Perangkat</label>
                                    <input type="file" accept="application/pdf" class="form-control foto_perangkat" name="data_perangkat_teknis_jasa[` + this.totalKonfigurasiTeknis + `][foto_perangkat]" required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
