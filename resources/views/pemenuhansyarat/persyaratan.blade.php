                    ...
                    <tbody>
                        @foreach ($datasyaratpdf as $syarat)
                            @if ($group != $syarat->group_by)
                                <tr>
                                    <td colspan="3">
                                        <label for="" class="text-bold">{{ $group }}</label>
                                    </td>
                                </tr>
                            @endif
                            <tr>
                                ...
                                <td class="col-7">
                                    ...
                                    @elseif($syarat->file_type == 'pdf')
                                        <input type="file" class="form-control" name="syarat[{{ $i }}]"  accept="application/pdf"
                                        ...
                                        @if ($syarat->download_link != null && $syarat->download_link != '')
                                            ...
                                            Download Lampiran Template <a target="_blank"
                                                href="{{ $syarat->download_link }}">Disini</a>
                                        @endif
