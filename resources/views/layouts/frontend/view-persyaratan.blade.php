        ...
        <div class="form-group">
            ...
            <div class="card">
                <div class="card-header bg-indigo text-white header-elements-inline">
                    <div class="row">
                        <div class="col-lg">
                            <h6 class="card-title font-weight-semibold py-3">Pemenuhan Persyaratan</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    ...
                                                    <textarea class="form-control disabled koreksi-catatan" id="catatan_dokumen_{{ $mi->id }}"
                                                        name="catatan_dokumen_{{ $mi->id }}" rows="2" readonly>{{ isset($mi->correction_note) ? $mi->correction_note : '' }}</textarea>
                                                </div> --}}
                                            </div>
                                        </div>
