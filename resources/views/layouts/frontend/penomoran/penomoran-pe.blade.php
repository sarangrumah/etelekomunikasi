...
<!-- @section('title', 'Permohonan Pengembalian Penomoran') -->
@section('js')
...
<div class="card">
    <div class="card-header bg-indigo text-white header-elements-inline">
        <div class="row">
            <div class="col-lg">
                <h6 class="card-title font-weight-semibold py-3">Pengembalian Kode Akses</h6>
            </div>
        </div>
    </div>
    <div class="card-body">
        <form action="{{ url('/penomoran/savepengembalian') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <fieldset>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <label class="col-lg-8 col-form-label">{{ $data->full_name }}</label>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <label class="col-lg-8 col-form-label">{{ $data->kode_akses }}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <label class="col-lg-8 col-form-label">{{ $data->id_izin }}
                                </label>
                            </div>
                        </div>
            ...
            <div class="text-right">
                <a onclick="history.back()" class="btn btn-light"><i class="icon-backward2 ml-2"></i> Kembali </a>
