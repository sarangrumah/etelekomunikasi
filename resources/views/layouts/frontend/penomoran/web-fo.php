...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/', function () {
        ...
        'proses','date_reformat','penomoran','kblijasa','kblijaringan','kblitelsus','kblitelsusip','kblinomor','kblinomor_pt','status_evaluasi'));
    });
    ...
    Route::prefix('/pb')->group(function () {
        ...
        Route::get('/pemenuhan-persyaratan/{id}', [App\Http\Controllers\PemenuhanPersyaratanController::class, 'formpersyaratan']);Route::get('/pemenuhan-persyaratan/{id}', [App\Http\Controllers\PemenuhanPersyaratanController::class, 'formpersyaratan']);
