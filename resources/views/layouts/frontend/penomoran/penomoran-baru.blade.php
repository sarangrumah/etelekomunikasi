...
<!-- <x-perizinan /> --> --}}
    ...
    <div class="card">
        <form
            action=" @if ($penambahan) {{ url('penomoran/savepenomoranpenambahan') }} @else {{ url('penomoran/savepenomoranbaru') }} @endif"
            id="frm" method="POST" enctype="multipart/form-data">
            @csrf

            <input type="hidden" name="id_oss_trxizin" value="{{ $idtrxizin }}">
            <input type="hidden" name="id_izin" value="{{ $id_izin }}">
            
            <input type="hidden" name="jenisnomor" value="{{ $short_name }}">
        ...
        $(document).ready(function() {
            ...
            $('select[name="perizinan"]').on('change', function() {
                ...
                if(izin == 'jasa') {
                    ...
                    $('select[name="jeniskbli"]').append('<option value="059000000032">Sertifikat Penyelenggaraan Jasa Panggilan Terkelola (Calling Card)</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000033">Sertifikat Penyelenggaraan Jasa Konten SMS Premium</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000052">Izin Penyelenggaraan Jasa Pusat Panggilan Informasi (Call Center)</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000058">Izin Penyelenggaraan Jasa Internet Teleponi untuk Keperluan Publik (ITKP)</option>');
                }else if(izin == 'jaringan'){
                    $('select[name="jeniskbli"]').find('option').remove();
                    $('select[name="jeniskbli"]').val('Silakan Pilih...');
                    $('select[name="jeniskbli"]').append('<option value="059000000042">Izin Penyelenggaraan Jaringan Tetap Lokal Berbasis Packet Switched melalui Media Non-Kabel (BWA)</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000043">Izin Penyelenggaraan Jaringan Tetap Sambungan Langsung Jarak Jauh</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000044">Izin Penyelenggaraan Jaringan Tetap Sambungan Internasional</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000046">Izin Penyelenggaraan Jaringan Bergerak Satelit </option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000063">Izin Penyelenggaraan Jaringan Tetap Lokal Berbasis Packet Switched melalui Media Non-Kabel (BWA)</option>');
                    $('select[name="jeniskbli"]').append('<option value="059000000064">Izin Penyelenggaraan Jaringan Bergerak Seluler (ITKP)</option>');
