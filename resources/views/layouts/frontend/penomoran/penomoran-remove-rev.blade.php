...
@section('custom-js')
	...
	<script nonce="unique-nonce-value" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
	<script nonce="unique-nonce-value" src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
