...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-indigo text-white header-elements-inline">
            <div class="row">
                <div class="col-lg">
                    <h6 class="card-title font-weight-semibold py-3">Pencabutan Kode Akses</h6>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form action="#">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="dropdown-divider"></div> --}}
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Jenis Kode Akses: </label>
                                <div class="col-lg-8">
                                    <label class="col-lg-8 col-form-label">Kode Akses Sambungan International (SI)</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Kode Akses:
                                </label>
                                <div class="col-lg-8">
                                    <label class="col-lg-8 col-form-label">011
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Surat Penetapan Penomoran:
                                </label>
                                <div class="col-lg-8">
                                    <label class="col-lg-8 col-form-label">I-201912311826376699027
                                    </label>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Catatan Pencabutan: </label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control h-auto required">
                                </div>
                            </div>
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-primary">Proses Pencabutan <i
