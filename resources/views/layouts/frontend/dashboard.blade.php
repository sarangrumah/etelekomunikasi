...
<script src="/global_assets/js/plugins/tables/datatables/extensions/buttons.min.js"></script> --}}
	<script nonce="unique-nonce-value" src="/global_assets/js/plugins/notifications/sweet_alert.min.js"></script>
...
--}}
	...
	<script nonce="unique-nonce-value" src="global_assets/js/demo_pages/components_popups.js"></script>
			...
			<table class="table text-nowrap datatable-button-init-basic" id="table">
				<thead>
					<tr>
						...
						<th class="text-center custom-width-th" nonce="unique-nonce-value"><i class="icon-arrow-down12"></i></th>
					</tr>
				</thead>
							...
							<div class="mb-4">
								<div class="mb-3">
									<div class="form-group row">
										...
										<div class="col-lg-8">
											<div class = "custom-div" nonce="unique-nonce-value">
