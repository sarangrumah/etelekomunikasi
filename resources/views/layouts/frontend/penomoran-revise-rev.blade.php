                    ...
                    <div class="col">
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select name="reasonrevise" class="form-control">
                            ...
                            @if ($pengembalian)
                                <div class="row">
                                    <div class="col-6">
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-4 form-group">
                                                <label class="col-form-label">No SK Penetapan<span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-lg-8 form-group">
                                                <input type="text" name="NoSKPenetapanPenomoran"
                                                    id="NoSKPenetapanPenomoran" class="form-control h-auto required"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 row">
                                            <div class="col-lg-4 form-group">
                                                <label class="col-form-label">Tanggal Penetapan<span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-lg-8 form-group">
                                                <input type="date" name="DateSKPenetapanPenomoran"
                                                    id="DateSKPenetapanPenomoran" class="form-control h-auto required"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="file" name="DOKPendukung" id="DOKPendukung"
                                                    class="form-control h-auto required" accept="application/pdf"
                                                    required>
                                            </div>
                                        </div>
