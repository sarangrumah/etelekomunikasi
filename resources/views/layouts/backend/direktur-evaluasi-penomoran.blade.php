            ...
            <div class="card-body">
                <form action="#">
                    ...
                    <div class="text-right">
                        {{-- <button type="button" class="btn btn-secondary border-transparent"><i class="icon-backward2 ml-2"></i> Kembali </i></button> --}}
                        ...
                        <!-- <button type="submit" class="btn btn-danger">Tolak Permohonan <i class="icon-paperplane ml-2"></i></button> -->
