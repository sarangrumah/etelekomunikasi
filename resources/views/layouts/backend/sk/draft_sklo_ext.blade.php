...
<body>
	...
	<div>
		<table style="text-align: justify !important;">
			<tr style="text-align: justify !important;vertical-align:top;">
				...
				<td width="79%">
					Keputusan Menteri Komunikasi dan Digital Republik Indonesia Nomor
					...
					berdasarkan Keputusan Menteri Komunikasi dan Digital Republik Indonesia Nomor
			...
			<tr style="text-align: justify !important;vertical-align:top;">
				...
				<td width="79%">
					Surat Tugas Direktur Layanan Infrastruktur Digital Nomor :
	...
	<div style="text-align:center !important;">
		<p><b>
				...
				<br />DIREKTORAT JENDERAL INFRASTRUKTUR DIGITAL
				<!-- EKOSISTEM DIGITAL -->
			</b></p>
	</div>
	...
	<div>
		<table>
			<tr>
				<td width="450px;">&nbsp;</td>
				<!-- <td style="text-align:center;">
				DIREKTUR LAYANAN EKOSISTEM DIGITAL,
