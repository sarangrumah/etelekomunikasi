	...
	<div>
		<ol>
			<li>PT {{ $nama_perseroan }} telah menyampaikan surat pernyataan pemenuhan kewajiban pembangunan dan/atau penyediaan
				Penyelenggaraan Jaringan tertanggal {{ date('d F Y') }}</li>
			<li>
				Menetapkan kewajiban pembangunan dan/atau penyediaan selama 5 (lima) tahun bagi PT {{ $nama_perseroan }} sebagai
				penyelenggara Jaringan Tetap Tertutup berdasarkan… (Keputusan Menteri Komunikasi dan Informatika No… Tahun…. tentang
				Izin Penyelenggaraaan Jaringan Tetap Tertutup PT {{ $nama_perseroan }}./Perizinan Berusaha Berbasis Risiko Izin:…..)
			...
			<br /><br /><br /><br />
			<li>
				PT {{ $nama_perseroan }}. wajib memenuhi komitmen kerja pelayanan jaringan telekomunikasi Penyelenggaraan Jaringan
				Tetap Tertutup sebagai berikut:
				<br /><br />
