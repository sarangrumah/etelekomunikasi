...
@section('js')
	...
	<!-- <script nonce="unique-nonce-value" src="https://cdn.ckeditor.com/4.24.0-lts/standard/ckeditor.js"></script> -->
	<!-- {{-- <script nonce="unique-nonce-value" src="{{ url('assets/js/ckeditor.js') }}"></script> --}} -->

	<!-- {{-- <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha384-Sha384CodeHere" crossorigin="anonymous"> --}} -->
	</script>
	<!-- Optionally include other scripts that rely on jQuery -->
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" id="btn_confirm_evaluasi" class="btn btn-primary notif-button">Kirim</button>
		...
		<div class="modal" id="submitModalKoreksi" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary notif-button" data-dismiss="modal">Batal</button>
						<button type="button" id="btn_correction_evaluasi" class="btn btn-primary notif-button">Kirim</button>
						<div class="spinner-border loading text-primary" role="status" hidden>
							<span class="sr-only">Loading...</span>
						</div>
					</div>
