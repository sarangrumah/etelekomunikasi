...
@section('content')
		...
		<form method="post" id="hasil_evaluasi"
			...
			<div class="card-body">
				...
				<textarea class="form-control" name="MediaTransmisiYangDigunakan" id="MediaTransmisiYangDigunakan"
					...
					required>{{ isset($ulo['alamat_pelaksanaan_ulo']) ? $ulo['alamat_pelaksanaan_ulo'] : '' }}</textarea>
				--}}
					</div>
				@else
					<div class="form-group">
						...
						{{-- <textarea class="form-control" name="alamatPusatLayananPelangan" id="alamatPusatLayananPelangan"
					rows="3" {{ $ulo['status_hasil_evaluasi']==1 ? 'disabled' : '' }}
					required>{{ isset($ulo['alamat_pusat_layanan_pelangan']) ? $ulo['alamat_pusat_layanan_pelangan'] : '' }}</textarea>
				--}}
					</div>
					<div class="form-group">
						<label for="AlamatPelaksanaanUlo">Alamat Pelaksanaan ULO</label>
				...
				<div class="col-lg-12">
					<fieldset>
						...
						<textarea rows="3" cols="3" class="form-control" placeholder="Hasil Evaluasi"
							...
							required>{{ isset($ulo['catatan_evaluasi']) ? $ulo['catatan_evaluasi'] : '' }}</textarea>
					</fieldset>
				</div>
			</div> --}}
				<div class="form-group text-right">
					...
					@elseif (isset($ulo['status_hasil_evaluasi']))
						<button type="button" id="btn_submit_simpan_evaluasi" class="btn btn-indigo">Sunting <i
								class="icon-paperplane ml-2"></i></button>
					@else
	...
	<div class="form-group text-right">
		...
		<button type="button" id="" data-target="#submitModal_syarat" data-toggle="modal"
			class="btn btn-indigo">Perbaharui
