	...
	<div class="card">
		...
		<div class="table-responsive">
			<table class="table text-wrap">
				...
				<tbody>
					<tr class="table-active table-border-double text-wrap">
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												@if ($help_open->status == 'Closed')
													<a href="/admin/updatelayanan/{{ $help_open->id }}" class="dropdown-item"><i class="icon-search4"></i>
														Lihat
														Detail</a>
												@else
													<a href="/admin/updatelayanan/{{ $help_open->id }}" class="dropdown-item"><i class="icon-search4"></i>
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											@if ($help_done->status == 'Closed')
												<a href="/admin/updatelayanan/{{ $help_done->id }}" class="dropdown-item"><i class="icon-search4"></i>
													Lihat
													Detail</a>
											@else
												<a href="/admin/updatelayanan/{{ $help_done->id }}" class="dropdown-item"><i class="icon-search4"></i>
													Lihat
													Detail</a>
												<a href="/tutuplayanan/{{ $help_done->id }}" class="dropdown-item"><i class="icon-task"></i>
													Tutup Ticket</a>
											@endif
										</div>
									</div>
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											@if ($help_cancelled->status == 'Closed')
												<a href="/admin/updatelayanan/{{ $help_cancelled->id }}" class="dropdown-item"><i
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											@if ($help_wia->status == 'Closed')
												<a href="/admin/updatelayanan/{{ $help_wia->id }}" class="dropdown-item"><i class="icon-search4"></i>
													Lihat
													Detail</a>
											@else
												<a href="/admin/updatelayanan/{{ $help_wia->id }}" class="dropdown-item"><i class="icon-search4"></i>
