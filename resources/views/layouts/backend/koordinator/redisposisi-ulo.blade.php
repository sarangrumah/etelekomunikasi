			...
			<div class="card-body">
				<form method="post" id="formDisposisi"
					...
					<div class="text-right">
						...
						<button type="button" data-toggle="modal" data-target="#submitModal" class="btn btn-indigo">Kirim Disposisi <i
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="btn_submit_disposisi" name="btn_submit_disposisi"
