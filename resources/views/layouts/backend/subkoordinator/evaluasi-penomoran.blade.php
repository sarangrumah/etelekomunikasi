...
@section('content')
	...
	<form method="post" id="formEvaluasi" enctype="multipart/form-data"
		...
		<div class="form-group">
			...
			<div class="text-right">
				...
				<button type="button" id="btnSubmitModal" class="btn btn-indigo">Kirim Evaluasi
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" id="btn_submitdisposisi" class="btn btn-primary notif-button">Kirim</button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="btn_submitpenolakan" class="btn btn-primary">Kirim</button>
				</div>
			</div>
		</div>
	</div>
	<script nonce="unique-nonce-value" type="text/javascript">
		$(document).ready(function() {
			...
			$("#btn_submitdisposisi").click(function(e) {
				// alert('working');
				submitdisposisi();
			});

			$("#btn_submitpenolakan").click(function(e) {
				// alert('working');
				btn_submitpenolakan();
			});
	...
	<script nonce="unique-nonce-value">
		...
		function submitdisposisi() {
			if ($('#status_sk').val() == 0 && $('#catatan_hasil_evaluasi').val() == '') {
				...
				// showLoadingSpinner();
				$('#formEvaluasi').submit();
				$("#btn_submitdisposisi").attr("disabled", true);
