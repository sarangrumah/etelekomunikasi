			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<div name="AlamatPelaksanaanUlo" id="AlamatPelaksanaanUlo"
					...
					@else
						...
						<div name="alamatPusatLayananPelangan" id="alamatPusatLayananPelangan"
							{{ $ulo['status_hasil_evaluasi'] == 1 ? 'disabled' : '' }} required>
...
@elseif($ulo['status_laik'] == '0')
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="btn_kirim_tolak" class="btn btn-primary">Kirim</button>
				</div>
			</div>
		</div>
	</div>
	<script type="text/javascript" nonce="unique-nonce-value">
		...
		$(document).ready(function() {
			if (document.getElementById('AlamatPelaksanaanUlo')) {
				const quillAlamatPelaksanaanUlo = new Quill('#AlamatPelaksanaanUlo', {
					theme: 'snow'
				});
			}
			if (document.getElementById('alamatPusatLayananPelangan')) {
				const quillalamatPusatLayananPelangan = new Quill('#alamatPusatLayananPelangan', {
					theme: 'snow'
				});
			}
        ...
        if (statusHasilEvaluasi == 1) {
            quillalamatPusatLayananPelangan.enable(false);  // Make the first editor read-only
            quillAlamatPelaksanaanUlo.enable(false);  // Make the second editor read-only
        }
