		...
		<div class="form-group">
			...
			<div>
								...
								<div class="form-group">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control" value="{{ $penomoran->id_izin }}" disabled>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control"
													value="{{ $date_reformat->date_lang_reformat_long($penomoran->tgl_permohonan) }}" disabled>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control" value="{{ $penomoran->jenis_permohonan }}" disabled>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control" value="{{ $penomoran->name_status_bo }}" disabled>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control" value="{{ $penomoran->nama_perseroan_alokasi }}" disabled>
											</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control" value="{{ $penomoran->nib_alokasi }}" disabled>
											</div>
										</div>
									</div>
									{{-- </div>
								...
								<div class="form-group">
									<div class="col-lg-12">
										<div class="row">
											...
											<div class="col-lg-8">
												<input type="text" class="col-lg form-control" value="{{ $penomoran->jenis_kode_akses_nonhtml }}"
													disabled>
											</div>
										</div>
									</div>
							...
							<div class="col-lg-12 row">
								...
								<div class="col-lg-10">
									<div class="input-group">
										<input disabled="disabled" type="text" class="form-control border-right-0"name="berkas_tambahan"
											placeholder="{{ $file4 }}">
				...
				<div class="form-group text-right">
					...
					<a href="{{ route('admin.sk.draftpenomoranpencabutan', [$penomoran->id_mst_kode_akses]) }}" target="_blank"
					...
					<button type="button" id="btn_submit" name="btn_submit" class="btn btn-indigo">Kirim
