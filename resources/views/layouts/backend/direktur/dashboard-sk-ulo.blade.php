...
<div>
    ...
    <div class="card">
        <div class="card-header d-flex py-0">
            <h6 class="card-title font-weight-semibold py-3">Daftar Permohonan Surat Keterangan Layak Operasi</h6>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div>
                                    <a href="{{route('admin.direktur.lihat-sk-ulo',$sk['id_izin'])}}"
                                        class="text-body font-weight-semibold">{{$sk['id_izin']}}</a>
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('admin.direktur.lihat-sk-ulo',$sk['id_izin'])}}"
                                        class="dropdown-item"><i class="icon-file-pdf"></i> Lihat Surat Penetapan</a>
                                    <!-- @if($sk['is_active'] == 1)
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah anda yakin akan mencabut Surat Keterangan Laik Operasi ini ?</p>
