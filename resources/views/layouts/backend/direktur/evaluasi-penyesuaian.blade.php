...
@endphp
<form method="post" id="formEvaluasi" action="{{route('admin.direktur.penetapanpenyesuaianpost',$id)}}">
		...
		<div class="card">
			...
			<div class="form-group text-right">
				...
				<button type="button" id="btnSubmitModal" data-target="#submitModal" data-toggle="modal"
					class="btn btn-indigo">Persetujuan {{$status}} Komitmen <i class="icon-paperplane ml-2"></i></button>
			</div>
		</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>Apakah anda yakin akan menyetujui perubahan komitmen ini ?</p>
					</div>
