                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg">
                                                <input type="text" class="form-control"
                                                    value="{!! $penomoran['jenis_layanan_html_nomor'] !!}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr class="bloknomor-item">
                                                    <td style="width: 40%;">
                                                        <div class="font-size-sm">
                                                            {{-- {{ $d['nama_wilayah'] }} --}}
                                                            <input type="text" id="nama_wilayah[{{ $item }}]"
                                                                class="form-control" value="{{ $d['nama_wilayah'] }}"
                                                                disabled>
                                                        </div>
                                                    </td>
                                                    <td style="width: 10%;">
                                                        <div class="font-size-sm">
                                                            {{-- {{ $d['kode_wilayah'] }} --}}
                                                            <input type="text" id="kode_wilayah[{{ $item }}]"
                                                                class="form-control" value="{{ $d['kode_wilayah'] }}"
                                                                disabled>
                                                        </div>
                                                    </td>
                                                    <td style="width: 10%;">
                                                        <div class="font-size-sm">
                                                            {{-- {{ $d['prefix_awal'] }} --}}
                                                            <input type="text" id="prefix_awal[{{ $item }}]"
