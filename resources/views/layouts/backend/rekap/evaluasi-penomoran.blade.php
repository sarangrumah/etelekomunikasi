    ...
    <form method="post" id="formEvaluasi"
        ...
        <div class="form-group">
                                        ...
                                        <div class="col-lg-8" id="PilihKodeWilayah">
                                            <table class="table table-custom table-sm">
                                                <thead>
                                                    <tr>
                                                        <th
                                                            style="border-top: none;background: #fafafa;text-align: center;">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append">
                                                        <a target="_blank"
                                                            href="{{ asset($penomoran['dok_call_center']) }}"
                                                            class="btn btn-teal" type="button">Lihat Dokumen</a>
                                                    </span>
                                                </div>
                                            </div>
            ...
            <div class="form-group text-right">
                <a href="{{ url('/admin') }}" class="btn btn-secondary border-transparent"><i
