...
@section('js')
    <script src="v{{ url('global_assets/js/plugins/forms/selects/select2.min.js') }}"></script>
    <script src="v{{ url('global_assets/js/demo_pages/form_layouts.js') }}"></script>

    <script src="v{{ url('global_assets/js/plugins/buttons/spin.min.js') }}"></script>
    <script src="v{{ url('global_assets/js/plugins/buttons/ladda.min.js') }}"></script>

    <script src="v{{ url('global_assets/js/demo_pages/components_buttons.js') }}"></script>
@endsection
@section('content')
            ...
            <div class="card-body">
                <form action="#">
                    ...
                    <div class="text-right">
                        ...
                        <button type="submit" class="btn btn-danger">Tolak Permohonan <i
                                class="icon-paperplane ml-2"></i></button>
                        <button type="submit" class="btn btn-indigo">Kirim Hasil evaluasi <i
                                class="icon-paperplane ml-2"></i></button>
                    </div>
                </form>
            </div>
