    ...
    <div id="daftar_perangkat_lists">
                    ...
                    @if ($d['isdeleted_perangkat'] == '1')
                        <div class="px-3 py-3 daftar-perangkat-item" style="border: 1px solid #ddd">
                            @if ($is_editable)
                                ...
                                <div>
                                    <select name="daftar_perangkat[{{ $key }}][isdeleted_perangkat]"
                                        id="" class="form-control isdeleted_perangkat" required>
                                        <option name="daftar_perangkat[{{ $key }}][isdeleted_perangkat]"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    {{-- <?php 
                                                    dd($d['sertifikasi_alat']); $name = explode('/', $d['sertifikasi_alat']); ?>--}}
                                                    <?php  
                                                    if ($is_editable) {
                            ...
                            @if (isset($d['sertifikasi_alat']) && $d['sertifikasi_alat'])
                                <div class="col-12">
                                    <div class="form-group">
                                        <p class="font-weight-semibold">Lampiran Sertifikasi Perangkat</p>
                                        <div class="input-group">
                                            {{-- <?php dd($d['sertifikasi_alat']);$name = explode('/', $d['sertifikasi_alat']); ?> --}}
                                            <?php 
                                            if ($is_editable) {
                                                ?><input type="file" accept="application/pdf"
                                                class="form-control"
        ...
        @else
            <div class="px-3 py-3 daftar-perangkat-item" style="border: 1px solid #ddd">
                <div>
                    <div>
                        <small for="" class="text-danger mr-2">*Catatan : Untuk beberapa perangkat, memiliki kententuan yang harus didaftarkan pada Layanan Sertifikasi <a href='https://sertifikasi.postel.go.id'> sertifikasi.postel.go.id </a>.</small>
                    </div>
                    <div class="">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Jenis Perangkat</label>
                            <input class="form-control jenis_perangkat" name="daftar_perangkat[0][jenis_perangkat]"
                                required />
                        </div>
                        <div class="form-group">
                            <label for="">Merk Perangkat</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="">Negara Asal Pembuat Perangkat</label>
                            <input class="form-control buatan_perangkat" name="daftar_perangkat[0][buatan_perangkat]"
                                required />
                        </div>
                        <div class="form-group">
                            <label for="">Foto <i>Serial Number</i> Perangkat</label>
