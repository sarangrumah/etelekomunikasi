...
Route::group(['prefix' => 'admin'], static function () {
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('/ulo-calendar', [Admin\ScheduleController::class, 'show'])->name('admin.evaluator.uloschedule')->middleware('jabatancheck');
        Route::get('/ulo-calendar-all', [Admin\ScheduleController::class, 'getschedule'])->name('admin.evaluator.getschedule')->middleware('jabatancheck');
        Route::get('/ulo-calendar-new', [Admin\ScheduleController::class, 'shownew'])->name('admin.evaluator.uloschedulenew')->middleware('jabatancheck');
        Route::get('/ulo-calendarmgt', [Admin\ScheduleController::class, 'manageschedule'])->name('admin.evaluator.manageschedule')->middleware('jabatancheck');
        Route::post('/schedule/store', [Admin\ScheduleController::class, 'store'])->name('admin.schedule.store')->middleware('jabatancheck');
        Route::post('/schedule/update/{id}', [Admin\ScheduleController::class, 'update'])->name('admin.schedule.update')->middleware('jabatancheck');
        Route::post('/schedule/destroy/{id}', [Admin\ScheduleController::class, 'destroy'])->name('admin.schedule.destroy')->middleware('jabatancheck');
